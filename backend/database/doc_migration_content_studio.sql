-- 📌 Unified Documentation Migration (NOT FOR EXECUTION)
-- This file is used exclusively by AI models and the development team
-- to generate dynamic SQL queries based on the actual schema.
-- DO NOT APPLY to any database.

-- ============================================
-- Content Studio Database Schema Reference
