...
-- Creates 6 default templates with 5 mandatory formats
-- Formats: text_audio, avatar_video, presentation, code, mind_map
-- ============================================
...
-- 5 formats: text_audio, presentation, code, mind_map, avatar_video
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Foundational Learning Flow',
    'ready_template',
    'system',
    '["text_audio", "presentation", "code", "mind_map", "avatar_video"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
-- 5 formats: text_audio, code, presentation, mind_map, avatar_video
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Hands-On Coding Sprint',
    'ready_template',
    'system',
    '["text_audio", "code", "presentation", "mind_map", "avatar_video"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
-- 5 formats: text_audio, mind_map, presentation, code, avatar_video
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Visual Storytelling Journey',
    'ready_template',
    'system',
    '["text_audio", "mind_map", "presentation", "code", "avatar_video"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
-- 5 formats: text_audio, presentation, mind_map, code, avatar_video
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Workshop Collaboration Loop',
    'ready_template',
    'system',
    '["text_audio", "presentation", "mind_map", "code", "avatar_video"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
-- 5 formats: text_audio, code, mind_map, presentation, avatar_video
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Assessment Ready Sequence',
    'ready_template',
    'system',
    '["text_audio", "code", "mind_map", "presentation", "avatar_video"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
...
-- 5 formats: text_audio, avatar_video, presentation, code, mind_map
INSERT INTO templates (template_name, template_type, created_by, format_order, created_at)
SELECT 
    'Immersive Video Kickoff',
    'ready_template',
    'system',
    '["text_audio", "avatar_video", "presentation", "code", "mind_map"]'::jsonb,
    CURRENT_TIMESTAMP
WHERE NOT EXISTS (
