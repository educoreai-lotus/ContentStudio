...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
      {/* Hero Section */}
      <section className="hero py-20 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-[#0f172a] dark:via-[#0f172a] dark:to-[#0f172a]">
      ...
      {/* Features Section */}
      <section className="microservices-section py-20 bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
